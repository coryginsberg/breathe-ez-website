...
<li class='field_block' id='field_8_div'><hr class='sectionbreak'>
Address To Be Cleaned</li>
<li class='field_block' id='field_3_div'><div class='col_label'>
	<label class='form_field'>Address Line 1</label> <label class='form_required' >*</label> </div>
	<div class='col_field'>
...
<li class='field_block' id='field_5_div'><div class='col_label'>
	<label class='form_field'>Address Line 2</label> <label class='form_required' >&nbsp;</label> </div>
	<div class='col_field'>
...
<li class='field_block' id='field_4_div'><div class='col_label'>
	...
	<div class='col_field'>
	<?php phpfmg_dropdown( 'field_4', "AL|AK|AZ|AR|CA|CO|CT|DE|FL|GA|HI|ID|IL=IL,default|IN|IA|KS|KY|LA|ME|MD|MA|MI|MN|MS|MO|MT|NE|NV|NH|NJ|NM|NY|NC|ND|OH|OK|OR|PA|RI|SC|SD|TN|TX|UT|VT|VA|WA|WV|WI|WY" );?>
